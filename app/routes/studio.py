...
def enforce_tool_access(
    *,
    ...
    has_access = tool_name in FREE_ALLOWED_TOOL_NAMES or current_plan in PAID_PLANS
    ...
    log_studio_usage_event(
        ...
        generation_ms=0,
        input_mode=input_mode,
        metadata_json=denied_metadata,
    )

    raise HTTPException(
        status_code=403,
        detail="This Studio tool is available on paid plans only. Upgrade to unlock it.",
    )
